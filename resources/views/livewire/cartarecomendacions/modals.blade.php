                    ...
                    <div class="form-group">
                        ...
                        <select wire:model="estudiante_id" type="text" class="form-control" id="estudiante_id" placeholder="Estudiante Id">@error('estudiante_id') <span class="error text-danger">{{ $message }}</span> @enderror
                            ...
                            @foreach ($estudiantes as $estudiante)
                                  <option value="{{$estudiante->estudianteId}}"> {{$estudiante->nombre}}</option>      
                            @endforeach
                        </select>
                    </div>
        ...
        <div class="modal-header" style="background-color: #005c35;">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        <label for="estudiante_id"><b style="color: black;">Estudiante<b></label>
                        <select wire:model="estudiante_id" type="text" class="form-control" id="estudiante_id" placeholder="Estudiante">@error('estudiante_id') <span class="error text-danger">{{ $message }}</span> @enderror
                            <option value="">estudiante</option>
                            @foreach ($estudiantes as $estudiante)
                                  <option value="{{$estudiante->estudianteId}}"> {{$estudiante->nombre}}</option>      
                            @endforeach
