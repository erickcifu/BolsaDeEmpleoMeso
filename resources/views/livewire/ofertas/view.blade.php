						...
						<tbody>
							...
							<tr>
								...
								<td width="125" >
									...
									<a data-bs-toggle="modal" data-bs-target="#VerPostulacionesModal" wire:click="verPostulaciones({{$row->ofertaId}})" style="color: Black; text-decoration: none;"><i class="fa fa-pen"></i> Postulaciones </a>			
								</td>
							</tr>
							@empty
							<tr>
