            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
						...
						<li class="nav-item">
                            <a href="{{ url('/carta-pdf') }}" class="nav-link" style="color: #f0eadc;">Cartas de recomendación</a> 
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/cvs') }}" class="nav-link" style="color: #f0eadc;"> Generar CV</a> 
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/ofertasestudiantes') }}" class="nav-link" style="color: #f0eadc;">Ofertas laborales</a> 
                        </li>
						<li class="nav-item">
                        ...
                        {{-- {{ Auth::user()->name }} --}}
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <div class="nav-item dropdown mt-3 card"style="background-color: #d3d3d3;display: flex; align-items: center;">    
                                        <a href="{{ url('/estudiantes') }}" wire:click="actualizarPerfil" class="nav-link">Perfil</a> 
                                    </div>
                                    <div class="nav-item dropdown mt-3 card"style="background-color: #d3d3d3;display: flex; align-items: center;">    
