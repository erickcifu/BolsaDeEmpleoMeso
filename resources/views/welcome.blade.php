...
<div class="container">
                ...
                <div class="carousel-inner">
                    ...
                    >
                        <div class="title-card-home">
                            <h1 class="text-center display-5" style="color: #f0eadc;">
                                {{ $facultad }}
                            </h1>
                        </div>
    ...
    <nav
        class="navbar fixed-bottom navbar-light bg-light px-5"
        style="background-color: #005c35 !important"
    >
    
        <img
            class="d-block w-5"
            src="https://picsum.photos/75/75?t=7"
            alt="Empresa 1"
            style="filter: none"
        />
        <img
        ...
        <img
            class="d-block w-5"
            src="https://picsum.photos/75/75?t=8"
            alt="Empresa 2"
        />
        <img
            class="d-block w-5"
            src="https://picsum.photos/75/75?t=9"
            alt="Empresa 2"
        />
    </nav>
